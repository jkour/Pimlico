unit mService.i18n.TRadioButton;
...
type
  Ti18nRadioButton = class(TmServiceBase)
  protected
...
procedure Ti18nRadioButton.invoke(const aParameters: string);
var
  obj: TObject;
...
begin
  ...
  obj:=TObject(poin^);
  if (obj is TRadioButton) then // and (obj.ClassType = TRadioButton) then
  begin
    component:=TRadioButton(poin^);
